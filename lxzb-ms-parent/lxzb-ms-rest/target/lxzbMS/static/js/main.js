...
layui.config({
    ...
    table.render({
        ...
        cols: [[ //表头
            ...
            {field: 'vc2sdkuserid', title: '用户userID', align: 'center', valign: 'middle' },
            {field: 'vc2areacode', title: '所属服务器', align: 'center', valign: 'middle'},
            {field: 'vc2sdkrecommanduserid', title: '推荐人userID', align: 'center', valign: 'middle'},
            {field: 'numchargenum', title: '到账金额(元)', align: 'center', valign: 'middle'},
            {field: 'vc2sdkagentuserid', title: '服务器代理商userID', align: 'center', valign: 'middle'},
            {field: 'datorder', title: '时间', align: 'center', valign: 'middle',width: 150},
