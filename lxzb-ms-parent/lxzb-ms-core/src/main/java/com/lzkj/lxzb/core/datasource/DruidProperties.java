package com.lzkj.lxzb.core.datasource;
...
public class DruidProperties {
    ...
    private String url = "jdbc:oracle:thin:@//192.168.1.221:1521/orcl";

    private String username = "rd_zslclubber";

    private String password = "mmqk";
